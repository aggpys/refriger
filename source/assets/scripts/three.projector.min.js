...
b.updateMatrixWorld();null===l.parent&&l.updateMatrixWorld();ia.copy(l.matrixWorldInverse.getInverse(l.matrixWorld));G.multiplyMatrices(l.projectionMatrix,ia);V.setFromMatrix(G);S=0;m.objects.length=0;m.lights.length=0;b.traverseVisible(function(a){a instanceof THREE.Light?m.lights.push(a):a instanceof THREE.Mesh||a instanceof THREE.Line?!1===a.material.visible||!0===a.frustumCulled&&!1===V.intersectsObject(a)||L(a):a instanceof THREE.Sprite&&!1!==a.material.visible&&(!0!==a.frustumCulled||!1!==V.intersectsSprite(a))&&
L(a)});!0===B&&m.objects.sort(fa);b=0;for(B=m.objects.length;b<B;b++){var e=m.objects[b].object,g=e.geometry;u.setObject(e);D=e.matrixWorld;K=0;if(e instanceof THREE.Mesh)if(g instanceof THREE.BufferGeometry){var k=g.attributes,e=g.groups;if(void 0!==k.position){for(var c=k.position.array,a=0,d=c.length;a<d;a+=3)u.pushVertex(c[a],c[a+1],c[a+2]);if(void 0!==k.normal)for(var J=k.normal.array,a=0,d=J.length;a<d;a+=3)u.pushNormal(J[a],J[a+1],J[a+2]);if(void 0!==k.uv)for(k=k.uv.array,a=0,d=k.length;a<
d;a+=2)u.pushUv(k[a],k[a+1]);if(null!==g.index)if(c=g.index.array,0<e.length)for(b=0;b<e.length;b++)for(d=e[b],a=d.start,d=d.start+d.count;a<d;a+=3)u.pushTriangle(c[a],c[a+1],c[a+2]);else for(a=0,d=c.length;a<d;a+=3)u.pushTriangle(c[a],c[a+1],c[a+2]);else for(a=0,d=c.length/3;a<d;a+=3)u.pushTriangle(a,a+1,a+2)}}else{if(g instanceof THREE.Geometry){var v=g.vertices,a=g.faces,d=g.faceVertexUvs[0];U.getNormalMatrix(D);for(var c=e.material,k=c instanceof THREE.MultiMaterial,J=!0===k?e.material:null,p=
